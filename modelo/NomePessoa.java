...
public class NomePessoa {
    ...
    public String getNome() { return this.nome.getTxt(); }

    protected void setNome(String nome) {
        this.nome = new Texto(nome);
    }

    public int getQtdePalavras(){ return this.nome.getQtdePalavras(); }
    public String getNomeInvertido(){ return this.nome.inverterTexto(); }
    ...
    private boolean verificaStr(String s){
        ...
        for (int i = 0; i < sRet.length; i++){
            if(sRet[i].equals(s)){ return true; }
        }
        return false;
    }
